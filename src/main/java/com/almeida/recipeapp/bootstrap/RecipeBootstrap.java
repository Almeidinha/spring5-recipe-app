package com.almeida.recipeapp.bootstrap;

import com.almeida.recipeapp.domain.*;
import com.almeida.recipeapp.enums.Difficulty;
import com.almeida.recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        // guacNotes.setRecipe(guacRecipe);  ##this is now fixed in the Recipe pojo
        ...
        // tacoNotes.setRecipe(tacosRecipe); this is now fixed in the POJO
